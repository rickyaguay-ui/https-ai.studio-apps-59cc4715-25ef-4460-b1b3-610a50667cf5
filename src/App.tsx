        ...
        <div className="flex items-center gap-4 text-xs font-mono">
          ...
          {needsAuth ? (
            <button
              ...
              className="flex items-center gap-2 p-1.5 px-3 bg-white hover:bg-slate-50 text-slate-700 rounded border border-white/10 transition-all font-sans font-semibold text-[11px] shadow-sm ml-2"
            >
              ...
              {isLoggingIn ? "Logging in..." : "Google Sign In"}
            </button>
          ) : (
            <button
              onClick={async () => {
              ...
              title="Sign Out"
              className="p-1.5 hover:bg-white/10 rounded border border-white/10 text-white/50 hover:text-white transition-all outline-none ml-2"
            >
              Sign Out
            </button>
          )}
          ...
          <button
            ...
            className="p-1.5 hover:bg-white/10 rounded border border-white/10 text-white/80 hover:text-red-300 transition-all outline-none ml-2"
          >
            Clear Caches
          </button>
        </div>
